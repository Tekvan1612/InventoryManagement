...
path('sub_category_dropdown/', views.sub_category_dropdown, name='sub_category_dropdown'),
path('equipment_dropdown/', views.equipment_dropdown, name='equipment_dropdown'),
path('fetch_equipment_by_category/', views.fetch_equipment_by_category, name='fetch_equipment_by_category'),
path('fetch_equipment_by_sub_category/', views.fetch_equipment_by_sub_category, name='fetch_equipment_by_sub_category'),
path('fetch_equipment_by_equipment_name/', views.fetch_equipment_by_equipment_name, name='fetch_equipment_by_equipment_name'),
path('get_stock_details_reports/', views.get_stock_details_reports, name='get_stock_details_reports'),
path('fetch_equipment_with_unscanned_count/', views.fetch_equipment_with_unscanned_count, name='fetch_equipment_with_unscanned_count'),  
path('transport_master/', views.transport_master, name='transport_master'),
path('add_transport/', views.add_transport, name='add_transport'),
path('fetch_transport_data/', views.fetch_transport_data, name='fetch_transport_data'),
path('fetch_transport_attachments/', views.fetch_transport_attachments, name='fetch_transport_attachments'),
