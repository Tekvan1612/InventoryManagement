...
path('get_category_dropdown/<int:category_id>/', views.get_category_dropdown, name='get_category_dropdown'),
...
path('delete_warehouse_master/<int:id>/', views.delete_warehouse_master, name='delete_warehouse_master'),
...
path('fetch_subcategory_name/<int:subcategory_id>/', views.fetch_subcategory_name, name='fetch_subcategory_name'),
path('fetch_subcategory_type/<int:subcategory_id>/', views.fetch_subcategory_type, name='fetch_subcategory_type'),
...
path('fetch_client_contact_number/', views.fetch_client_contact_number, name='fetch_client_contact_number'),
